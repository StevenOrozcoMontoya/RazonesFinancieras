        ...
        <div class="row display-table-row">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="" style="cursor: pointer;"> <a href="liquidez.php" id="Liqui"  ><i class="fa fa-money" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Razones​ ​de​ ​liquidez</span></a></li>
                         <li class="active" style="cursor: pointer;"><a id="endeudamiento"><i class="fa fa-balance-scale" aria-hidden="true"></i><span class="hidden-xs hidden-sm">R. endeudamiento</span></a></li>
                        <li style="cursor: pointer;"><a href="rentabilidad.php" id="rentabilidad"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">R. ​rentabilidad</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <h1>Razones de endeudamiento</h1>
                    <div class="row">
...
$query .= "SELECT @valor;";
 ...
 echo  $conexion->mutiquery($query);
                 ...
                 ?></td>
                        <td><?php 
                        $query  = "call Razon_endeudamiento('".  $_SESSION['segundoPeriodoI'] ."', '".  $_SESSION['segundoPeriodoF'] ."',@valor);";
$query .= "SELECT @valor;";
 echo  $conexion->mutiquery($query);
                         ?></td>
                    </tr>
                    <tr>
                        ...
                        <td><?php 
                        $query  = "call Razon_pasivo_capital_contable('". $_SESSION['primerPeriodoI'] ."', '". $_SESSION['primerPeriodoF'] ."',@valor);";
                        $query .= "SELECT @valor;";
                        echo  $conexion->mutiquery($query);
                         ?></td>
                        <td><?php 
                        $query  = "call Razon_pasivo_capital_contable('".  $_SESSION['segundoPeriodoI'] ."', '".  $_SESSION['segundoPeriodoF'] ."',@valor);";
                        $query .= "SELECT @valor;";
                        echo  $conexion->mutiquery($query);
                         ?></td>
                    </tr>
